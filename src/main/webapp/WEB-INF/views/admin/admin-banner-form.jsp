...
<div class="admin-container">
    ...
    <div class="admin-content">
        ...
        <div class="admin-form">
            <form action="${pageContext.request.contextPath}/admin/banner/${empty banner ? 'add' : 'edit'}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="image" name="image" accept="image/*" ${empty banner ? 'required' : ''}>
                    <c:if test="${not empty banner.imagePath}">
